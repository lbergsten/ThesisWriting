...
\begin{figure}[!htbp]
\centering
  \includegraphics[width=.4\linewidth]{Pictures/Top+WWvsEverything/CorrelationMatrixS.eps}
  \includegraphics[width=.4\linewidth]{Pictures/Top+WWvsEverything/CorrelationMatrixB.eps}
...
\begin{figure}[!htbp]
\centering
  \includegraphics[width=.4\linewidth]{Pictures/TopvsWW/CorrelationMatrixS.eps}
  \includegraphics[width=.4\linewidth]{Pictures/TopvsWW/CorrelationMatrixB.eps}
...
\begin{figure}[!h]
  \subfloat[$\Delta Y_{\ell\ell}$]{
      \includegraphics[width=0.3\textwidth]{Pictures/run2-emme-CutVBFggFCR3ZttVeto_2jet-DYll-log.pdf}
  }\hfill
  \subfloat[$\Delta \Phi_{\ell\ell}$]{
      \includegraphics[width=0.3\textwidth]{Pictures/run2-emme-CutVBFggFCR3ZttVeto_2jet-DPhill-log.pdf}
  }\hfill
  \subfloat[$m_{\ell\ell}$]{
      \includegraphics[width=0.3\textwidth]{Pictures/run2-emme-CutVBFggFCR3ZttVeto_2jet-Mll-log.pdf}
  }\hfill
  \subfloat[$m_T$]{
      \includegraphics[width=0.3\textwidth]{Pictures/run2-emme-CutVBFggFCR3ZttVeto_2jet-MT-log.pdf}
  }\hfill
%  \subfloat[$p^T_{tot}$]{
