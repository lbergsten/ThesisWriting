...
\hline
\multicolumn{2}{|c|}{$Z$-veto ($m_{\tau\tau}$)} & $!Z$-veto ($m_{\tau\tau}$) &\multicolumn{4}{|c|}{$Z$-veto ($m_{\tau\tau}$)} \\
\hline
...
\begin{tabular}{|l|c|c|}
\hline
Background   & Relative size in SR & Estimation \\
\hline                                                         
$WW$                       & $\sim19\%$    & MC only + BDT  \\
Top                        &  $\sim36\%$     & MC only + BDT \\ 
$ggF$ Higgs                &  $\sim6.7\%$     & MC only + BDT (ABCD) \\         
$W$+jets                   & $\sim6.0\%$     & Data-driven  \\ 
$Z\rightarrow \tau\tau$    & $\sim29\%$              & Data+MC ($Z\rightarrow \tau\tau$ CR) \\
$W\gamma$, $W\gamma^{*}$, $ttH$, $VH$    &  $\sim2.8\%$    & MC only  \\
\hline
\end{tabular}
}
...
\centering
  ...
  \subfloat[ggF 3 control region]{
      \includegraphics[width=0.3\textwidth]{Pictures/fitresults/GGFCR3.pdf}
  }\hfill
