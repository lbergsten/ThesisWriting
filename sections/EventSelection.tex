...
The following plots \ref{fig:signalregion} show kinematic distributions after the described selection. Here only MC predictions are shown since data is blinded in the signal region. \textcolor{red}{Unblinded distributions will be added}. 
\begin{figure}[!h]
  \subfloat[$\Delta Y_{\ell\ell}$]{
